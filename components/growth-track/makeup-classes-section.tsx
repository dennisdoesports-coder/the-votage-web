...
import { MakeUpFormModal } from '@/components/gta-form/makeup-form';
...
export default function MakeUpClassesSection() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="grid md:grid-cols-2 gap-0">
              ...
              >
                <img 
                  src="/img/gta/section-2.png" 
                  alt="Group of graduates holding certificates" 
              ...
              <div className="flex flex-col items-center justify-center px-8 py-16 md:px-12 lg:px-16 lg:py-20">
                ...
                >
                  ...
                  <div className="font-['Arial',sans-serif] text-lg md:text-[24px] leading-[1.4] text-[#5e5d5d] text-center mt-2">
                    Missed a class or need to revisit a lesson? Catch up here.
                  </div>
      ...
      {/* Make Up Form Modal */}
      <MakeUpFormModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </>
  );
}
