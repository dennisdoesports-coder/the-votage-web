...
export function CTASection() {
  ...
  return (
    <motion.div
      className="w-full bg-[#F96800] py-16 md:py-20 lg:py-24 px-6 md:px-8"
      initial={{ opacity: 0 }}
    ...
    >
      <div className="max-w-[850px] mx-auto text-center">
        {/* Heading */}
        <motion.h2
          className="text-[36px] font-display md:text-[42px] lg:text-[48px] font-bold tracking-tight leading-tight mb-5"
        ...
        {/* Description */}
        <motion.p
          className="text-[15px] md:text-[16px] lg:text-[24px] text-black/85 leading-relaxed mb-8 md:mb-10 max-w-[700px] mx-auto px-4"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
